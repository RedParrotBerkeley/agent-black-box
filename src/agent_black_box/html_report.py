  ...
  <div class=\"wrap\">
    <section class=\"hero\">
      ...
      <div class=\"hero-badges\">
        <div class=\"badge badge-danger\">Failure path visible</div>
        <div class=\"badge\">Static artifact</div>
        <div class=\"badge badge-good\">Shareable without raw logs</div>
      </div>
      ...
      <div class=\"highlight-grid\">
        <div class=\"highlight-box\">
          <div class=\"highlight-label\">Operator question</div>
          <div class=\"highlight-value\">What failed?</div>
        </div>
        <div class=\"highlight-box\">
          <div class=\"highlight-label\">Answer surfaced</div>
          <div class=\"highlight-value\">pytest returned exit code 1</div>
        </div>
        <div class=\"highlight-box\">
          <div class=\"highlight-label\">Why this exists</div>
          <div class=\"highlight-value\">Turn agent runs into inspectable incidents</div>
        </div>
      </div>
    </section>
